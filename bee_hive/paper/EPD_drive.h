...
#define EPD_CS_0       GPIO_write(PAPER_CS, 0)
#define EPD_CS_1       GPIO_write(PAPER_CS, 1)
#define isEPD_CS       GPIO_read(PAPER_CS)

#define EPD_RST_0      GPIO_write(PAPER_RST, 0)
#define EPD_RST_1      GPIO_write(PAPER_RST, 1)
#define isEPD_RST      GPIO_read(PAPER_RST)

#define EPD_DC_0       GPIO_write(PAPER_DC, 0)
#define EPD_DC_1       GPIO_write(PAPER_DC, 1)

#define isEPD_BUSY     GPIO_read(PAPER_BUSY)
...
typedef void (*Delay)(unsigned long xms);
typedef void (*SpiWrite)(unsigned char value);
...
void Dis_showtime(unsigned char xStart,unsigned char yStart,unsigned int hour,unsigned int min,unsigned int sec);
void Dis_Text();
